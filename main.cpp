...
int32_t Render(SDL_Window* pWindow, SDL_Renderer* pRenderer, SDL_Texture* pTexture, uint32_t* pTempPixelBuffer)
{
...
int main()
{
    ...
    MapGen map = MapGen(g_kRenderWidth, g_kRenderHeight, 4, 2.5f, 0.3f);
    ...
    while (running)
    {
        ...
        {
            if (e(Render(pWindow, pRenderer, pTexture, pixelBuffer), "Render failed\n")) break;
